...
# the "-ai" suffix the agency uses on most repo names (BuyBox-AI → buybox,
...
detect_slug() {
  ...
  # Trim "-ai" suffix when the repo name ends in it (BuyBox-AI convention)
  raw="${raw%-ai}"
...
SLUG=$(detect_slug)
VAULT_PATH_DEFAULT="$HOME/code/newearth-agency-main/agency/vault"
SUPABASE_URL_DEFAULT="https://ridqdojzjotlvexfuwvx.supabase.co"
KEYCHAIN_ITEM_DEFAULT="agency-supabase-newearthai-service-role-jwt"
...
This usually means the Agency-Main repo isn't cloned at the conventional path.
Either:
  (a) clone Agency-Main: git clone <agency-main-url> ~/code/newearth-agency-main
  (b) edit $CONFIG and set vault_path to wherever Agency-Main's agency/vault lives
