...
#   [entity]            optional; defaults to env var CODE_EMITTER_ENTITY or 'BuyBox-AI'
...
NODES_FILE="${1:-}"
EDGES_FILE="${2:-}"
ENTITY="${3:-${CODE_EMITTER_ENTITY:-BuyBox-AI}}"
...
# ("Argument list too long") once the combined payload approaches that cap. At BuyBox-AI v1
