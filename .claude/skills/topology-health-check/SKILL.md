...
SKIPPED (correctly not-run on a degenerate stack like your project — skipping them is what stops the gate
...
- Integration test: `evals/integration.sh` (the v1-complete proof — repo-config-emitter + pre-seeded
  ...
  assertion ran; on a machine without the my-project substrate it prints "FIXTURE PROOF" not "v1-COMPLETE",
