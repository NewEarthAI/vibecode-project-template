#!/usr/bin/env bash
# ==============================================================================
# NewEarth UI Design — Color Discipline Audit
# ------------------------------------------------------------------------------
...
echo "================================================================"
echo "NewEarth UI Design — Color Discipline Audit"
echo "================================================================"
...
if [ "$VIOLATIONS" -eq 0 ]; then
  ...
  echo "  .claude/skills/newearth-ui-design/references/color-discipline.md"
  exit 1
fi
