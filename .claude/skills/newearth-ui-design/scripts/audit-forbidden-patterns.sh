#!/usr/bin/env bash
# ==============================================================================
# NewEarth UI Design — Forbidden Patterns Audit
# ------------------------------------------------------------------------------
...
echo "================================================================"
echo "NewEarth UI Design — Forbidden Patterns Audit"
echo "================================================================"
...
if [ "$VIOLATIONS" -eq 0 ]; then
  ...
  echo "  .claude/skills/newearth-ui-design/references/anti-vibe-coded.md"
  exit 1
fi
