...
truth**: live observation of `mcp__n8n-mcp-honeybird__n8n_get_workflow(mode="active")` against
BuyBox-AI's honeybird instance (verified 2026-05-26).
...
inactive+archived (the "graveyard" — present in BuyBox-AI), inactive+not-archived (older
working copies, the bulk of the "deal intake" tag at BuyBox-AI), or active+not-archived
...
The shape above is verified empirically against the live honeybird instance — what
