...
workflow is **outside the scope** (a your project workflow calls a non-your project workflow), the edge
...
each project organises its work via folder/tag conventions (not necessarily
