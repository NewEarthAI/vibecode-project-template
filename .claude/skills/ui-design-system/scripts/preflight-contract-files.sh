...
if [ "$fail" -gt 0 ]; then
  echo ""; echo "FAIL — $fail contract file(s) missing. ui-design-system will HALT on invocation."; echo "Run 'impeccable teach' (interactive, the operator in the loop) to author PRODUCT.md + DESIGN.md."; echo "Ref: continuations/NEWEARTH-DESIGN-SUITE-V2-MASTER-CONTINUATION-2026-05-13.md §15 (A2, A6)."; exit 1
fi
