...
A dedicated hero slot at the top of client dashboards for an upscaled, cinematic, AI-enhanced version of the client's logo — a visual stamp that communicates "your AI transformation is underway". Small "Powered by the agency" subtitle beside it.
...
- **Attribution**: "Powered by the agency" in small tracked label beside or beneath the hero logo — never dominant
...
- How is the "Powered by the agency" attribution styled — wordmark, icon, both?
