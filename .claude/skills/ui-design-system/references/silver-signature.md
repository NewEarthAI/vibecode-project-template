# Silver Signature — The the agency Fingerprint

> **What this is**: The one visual element that unmistakably marks a the agency-built interface. Silver is not used for information — it is used for *identity*. A client should never ask "what is that color", but over time they should recognize that every the agency dashboard has the same quiet metallic quality.
...
**Default for most premium cards**: A (edge) + C (hover ring). This is the "the agency premium card" recipe.
...
*This is the the agency fingerprint. Treat it carefully — over-use destroys it.*
