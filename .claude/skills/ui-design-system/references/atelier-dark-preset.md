...
| Default the agency | Atelier Dark |
|------------------|--------------|
...
Default the agency motion is 300ms — functional, immediate.
...
Default the agency: 12-column grid, symmetric. Atelier Dark: asymmetric two-column layout with a narrow **margin-note column** on the left (320px) and a wide content column (flex).
...
**Use it for**:
- the agency agency internal dashboard (the context that prompted this preset)
...
- **Gallery of reference implementations** — the agency agency internal dashboard when it ships; client proposal sites

---

*Atelier Dark is a deliberate luxury. Treat it as such. A the agency project that uses Atelier Dark when the default system would have served better is a bigger failure than one that uses the default when Atelier Dark would have been more appropriate. Restraint about restraint is the meta-discipline.*
