---
name: design-review
description: Run a the agency Design Suite review on any input — live URL, attached screenshot, screenshot file path, code path, or Figma export. Pulls the full L1 + L2 + L3 stack and grades against every layer.
---

# /design-review

Run a the agency Design Suite review on whatever you point me at. Accepts:

| Input | How to invoke |
|---|---|
| **Live URL** | `/design-review https://example.com/page` |
...
| **Code path** | `/design-review src/components/Example.tsx` |
